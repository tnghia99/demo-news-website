			...
			<ul class="nav ace-nav">
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#" class="clearfix"> <img
										src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/avatar.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/avatar3.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/avatar4.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/avatar2.png"
								...
								<li><a href="#" class="clearfix"> <img
										src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/avatar5.png"
				...
				<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
					href="#" class="dropdown-toggle"> <img class="nav-user-photo"
						src="${pageContext.request.contextPath}/template/admin/assets/images/avatars/user.jpg"
